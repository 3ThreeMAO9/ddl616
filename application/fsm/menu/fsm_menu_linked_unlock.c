...
#include "ob_log.h"
#define TAG "fsm_menu_linked_unlock"

/***************Variable***************/
static QState menu_linked_unloc_event_handle(LockFsm *me, QEvent const *e)
{
...
QState lock_fsm_menu_linked_unlock(LockFsm *me, QEvent const *e)
{
    ...
    OB_LOGD(TAG, "Fsm_state[%s], Event[%u, %u]", "menu_linked_unlock", e->sig, e->dynamic_[0]);
