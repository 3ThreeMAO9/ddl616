...
typedef enum{
    ...
    EVENT_RESULT_SUCCESS_OPENED,
    EVENT_RESULT_SUCCESS_CLOSED,
    EVENT_RESULT_SUCCESS_RESET,     //复位成功
    EVENT_RESULT_SUCCESS_DELETE_ALL,//全部删除成功
    ...
    EVENT_RESULT_BREAK_LONG_PRESS,      //防撬按键长按
    EVENT_RESULT_BREAK_WARN,            //防撬报警
    ...
    EVENT_RESULT_TIME,
    EVENT_RESULT_BLUE_MAC,
    EVENT_RESULT_SN,
    EVENT_RESULT_PID,
    //produce test
    EVENT_RESULT_PRODUCE_INIT,
    EVENT_RESULT_SLEEP,
    EVENT_RESULT_AGING_TEST,
    EVENT_RESULT_AGING_TEST_TIME,
    EVENT_RESULT_DEVICE_TEST_RESULT,
