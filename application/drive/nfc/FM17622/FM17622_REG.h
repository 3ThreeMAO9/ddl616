...
//#define     JBIT_CHECKRF            0x04   /*Does not activate the driver if an external RF is detected. Only valid in combination with JBIT_TX2RFEN and JBIT_TX1RFEN. */
...
#define   RF_DET_SEN_00                0x00 //      
#define   RF_DET_SEN_01                0x08
#define   RF_DET_SEN_10                0x10
#define   RF_DET_SEN_11                0x18 //      
