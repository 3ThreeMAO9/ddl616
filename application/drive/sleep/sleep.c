...
void unused_gpio_init(void)
{
    ...
    HAL_GPIO_Write(HAL_GPIO_PORT2, HAL_GPIO_PIN5, 1); // 
    HAL_GPIO_Init(HAL_GPIO_PORT2, HAL_GPIO_PIN5, HAL_GPIO_MODE_INPUT_PULLUP, HAL_GPIO_PULL_NONE);

    HAL_GPIO_Write(HAL_GPIO_PORT2, HAL_GPIO_PIN6, 1); // 
    HAL_GPIO_Init(HAL_GPIO_PORT2, HAL_GPIO_PIN6, HAL_GPIO_MODE_INPUT_PULLUP, HAL_GPIO_PULL_NONE);
}
