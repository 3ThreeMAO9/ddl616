...
typedef enum
{
    ...
    VOICE_For_user_settings_press,                                         // 用户设置请按
    VOICE_For_system_settings_press,                                       // 系统设置请按
    VOICE_To_cancel_please_press_the_asterisk_key,                         // 取消请按星号键
    VOICE_Test_successful,                                                 // 测试成功
    VOICE_Test_failed,                                                     // 测试失败
    VOICE_For_language_settings_press,                                     // 语言设置请按
