...
//parameter addr
#define PARAMETER_PAGE_START_ADDR       (USER_PAGE_BACKUP_ADDR + FLASH_ERASE_SIZE * USER_PAGE_CNT)  //0x5000
#define PARAMETER_PAGE_BACKUP_ADDR      (PARAMETER_PAGE_START_ADDR + FLASH_ERASE_SIZE * PARAMETER_PAGE_CNT) //0x6000

//produce data addr
#define PRODUCE_DATA_PAGE_START_ADDR    (PARAMETER_PAGE_BACKUP_ADDR + FLASH_ERASE_SIZE * PARAMETER_PAGE_CNT)    //0x7000

//log data addr
#define LOCK_LOG_FLASH_ADDR             (PRODUCE_DATA_PAGE_START_ADDR + FLASH_ERASE_SIZE * PRODUCE_DATA_PAGE_CNT)   //0x8000

//test data addr
#define GC_SECTOR_ADDR                  (LOCK_LOG_FLASH_ADDR + FLASH_ERASE_SIZE * LOCK_LOG_SECTOR_NUM)      //0xA000
