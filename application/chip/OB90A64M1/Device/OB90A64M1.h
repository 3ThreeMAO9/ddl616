...
typedef struct {                                    /*!< UART Structure                                                        */
  ...
  union {
    __IO uint32_t  UFCR;                            /*!< FIFO Control Register. Controls UART FIFO usage and modes.            */
    
    struct {
      __IO uint32_t  FIFOEN     :  1;               /*!< FIFO enable                                                           */
      __IO uint32_t  RXFIFORES  :  1;               /*!< RX FIFO Reset                                                         */
      __IO uint32_t  TXFIFORES  :  1;               /*!< TX FIFO Reset                                                         */
           uint32_t             :  3;
      __IO uint32_t  RXTL       :  2;               /*!< RX Trigger Level. These two bits determine how many receiver
...
typedef struct {                                    /*!< QEI Structure                                                         */
  ...
  union {
    __O  uint32_t  IEENS;                           /*!< Interrupt enable clear register                                       */
